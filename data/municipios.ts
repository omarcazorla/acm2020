...
export const municipios: Municipio[] = [
  ...
  generateMunicipioData('vilafranca-del-penedes', 'Vilafranca del Penedès', 'Vilafranca del Penedès', 'Barcelona', 'Alt Penedès', 'baja'),
  generateMunicipioData('sant-sadurni-danoia', 'Sant Sadurní d\'Anoia', 'Sant Sadurní d\'Anoia', 'Barcelona', 'Alt Penedès', 'baja'),
  ...
  generateMunicipioData('santa-margarida-de-montbui', 'Santa Margarida de Montbui', 'Santa Margarida de Montbui', 'Barcelona', 'Anoia', 'baja'),
  ...
  generateMunicipioData('rubí', 'Rubí', 'Rubí', 'Barcelona', 'Vallès Occidental', 'baja'),
  ...
  generateMunicipioData('la-garriga', 'La Garriga', 'la Garriga', 'Barcelona', 'Vallès Oriental', 'baja'),
  ...
  // Barcelona - Moianès
  generateMunicipioData('moià', 'Moià', 'Moià', 'Barcelona', 'Moianès', 'baja'),
  ...
  generateMunicipioData('les-preses', 'Les Preses', 'Les Preses', 'Girona', 'Garrotxa', 'baja'),
  ...
  generateMunicipioData('llívia', 'Llívia', 'Llívia', 'Girona', 'Cerdanya', 'baja'),
  ...
  // Lleida - Alt Urgell
  generateMunicipioData('la-seu-durgell', 'La Seu d\'Urgell', 'la Seu d\'Urgell', 'Lleida', 'Alt Urgell', 'baja'),
  // Lleida - Pallars Jussà
  generateMunicipioData('tremp', 'Tremp', 'Tremp', 'Lleida', 'Pallars Jussà', 'baja'),
  ...
  generateMunicipioData('el-pont-de-suert', 'El Pont de Suert', 'el Pont de Suert', 'Lleida', 'Alta Ribagorça', 'baja'),
  ...
  // Tarragona - Alt Camp
  generateMunicipioData('valls', 'Valls', 'Valls', 'Tarragona', 'Alt Camp', 'baja'),
  // Tarragona - Conca de Barberà
  generateMunicipioData('montblanc', 'Montblanc', 'Montblanc', 'Tarragona', 'Conca de Barberà', 'baja'),
  // Tarragona - Priorat
  generateMunicipioData('falset', 'Falset', 'Falset', 'Tarragona', 'Priorat', 'baja'),
  ...
  generateMunicipioData('gandesa', 'Gandesa', 'Gandesa', 'Tarragona', 'Terra Alta', 'baja'),
  ...
  generateMunicipioData('polinyà', 'Polinyà', 'Polinyà', 'Barcelona', 'Vallès Occidental', 'baja'),
  ...
  generateMunicipioData('les-franqueses-del-valles', 'Les Franqueses del Vallès', 'les Franqueses del Vallès', 'Barcelona', 'Vallès Oriental', 'baja'),
  ...
  // More Bages
  generateMunicipioData('monistrol-de-montserrat', 'Monistrol de Montserrat', 'Monistrol de Montserrat', 'Barcelona', 'Bages', 'baja'),
  generateMunicipioData('castellbell-i-el-vilar', 'Castellbell i el Vilar', 'Castellbell i el Vilar', 'Barcelona', 'Bages', 'baja'),
  generateMunicipioData('sant-vicenç-de-castellet', 'Sant Vicenç de Castellet', 'Sant Vicenç de Castellet', 'Barcelona', 'Bages', 'baja'),
  generateMunicipioData('el-pont-de-vilomara-i-rocafort', 'El Pont de Vilomara i Rocafort', 'el Pont de Vilomara i Rocafort', 'Barcelona', 'Bages', 'baja'),
  generateMunicipioData('artes', 'Artés', 'Artés', 'Barcelona', 'Bages', 'media'),
  generateMunicipioData('avinyó', 'Avinyó', 'Avinyó', 'Barcelona', 'Bages', 'baja'),
  // More Osona
  generateMunicipioData('el-brull', 'El Brull', 'el Brull', 'Barcelona', 'Osona', 'baja'),
  ...
  generateMunicipioData('la-pobla-de-lillet', 'La Pobla de Lillet', 'la Pobla de Lillet', 'Barcelona', 'Berguedà', 'baja'),
  // More Girona - Selva
  ...
  generateMunicipioData('el-papiol', 'El Papiol', 'el Papiol', 'Barcelona', 'Baix Llobregat', 'baja'),
  ...
  generateMunicipioData('la-pobla-de-claramunt', 'La Pobla de Claramunt', 'la Pobla de Claramunt', 'Barcelona', 'Anoia', 'baja'),
  generateMunicipioData('els-hostalets-de-pierola', 'Els Hostalets de Pierola', 'els Hostalets de Pierola', 'Barcelona', 'Anoia', 'baja'),
  generateMunicipioData('masquefa', 'Masquefa', 'Masquefa', 'Barcelona', 'Anoia', 'baja'),
  ...
  generateMunicipioData('cervelló', 'Cervelló', 'Cervelló', 'Barcelona', 'Baix Llobregat', 'baja'),
  ...
  generateMunicipioData('la-palma-de-cervello', 'La Palma de Cervelló', 'la Palma de Cervelló', 'Barcelona', 'Baix Llobregat', 'baja'),
  ...
  generateMunicipioData('sant-fruitós-de-bages', 'Sant Fruitós de Bages', 'Sant Fruitós de Bages', 'Barcelona', 'Bages', 'baja'),
  ...
  generateMunicipioData('les-masies-de-voltrega', 'Les Masies de Voltregà', 'les Masies de Voltregà', 'Barcelona', 'Osona', 'baja'),
  ...
  generateMunicipioData('aleixar', 'L\'Aleixar', 'l\'Aleixar', 'Tarragona', 'Baix Camp', 'baja'),
  ...
  generateMunicipioData('llança', 'Llança', 'Llança', 'Girona', 'Alt Empordà', 'baja'),
  ...
  generateMunicipioData('el-masnou', 'El Masnou', 'el Masnou', 'Barcelona', 'Maresme', 'baja'),
  ...
  generateMunicipioData('la-roca-del-valles', 'La Roca del Vallès', 'la Roca del Vallès', 'Barcelona', 'Vallès Oriental', 'baja'),
  ...
  generateMunicipioData('ametlla-del-valles', 'L\'Ametlla del Vallès', 'l\'Ametlla del Vallès', 'Barcelona', 'Vallès Oriental', 'baja'),
