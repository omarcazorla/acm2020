...
export const municipios: Municipio[] = [
  ...
  generateMunicipioData('sant-cebria-de-vallalta', 'Sant Cebria de Vallalta', 'Sant Cebria de Vallalta', 'Barcelona', 'Maresme', 'alta'),
  ...
  generateMunicipioData('premia-de-mar', 'Premia de Mar', 'Premia de Mar', 'Barcelona', 'Maresme', 'media'),
  generateMunicipioData('teia', 'Teia', 'Teia', 'Barcelona', 'Maresme', 'alta'),
  generateMunicipioData('orrius', 'Orrius', 'Orrius', 'Barcelona', 'Maresme', 'alta'),
  ...
  generateMunicipioData('sant-vicenc-de-montalt', 'Sant Vicenc de Montalt', 'Sant Vicenc de Montalt', 'Barcelona', 'Maresme', 'alta'),
  generateMunicipioData('premia-de-dalt', 'Premia de Dalt', 'Premia de Dalt', 'Barcelona', 'Maresme', 'alta'),
  ...
  // Barcelona - Valles Oriental (new from old site scrape)
  generateMunicipioData('vallromanes', 'Vallromanes', 'Vallromanes', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('figaro-montmany', 'Figaro-Montmany', 'Figaro-Montmany', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('montornes-del-valles', 'Montornes del Valles', 'Montornes del Valles', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('sant-fost-de-campsentelles', 'Sant Fost de Campsentelles', 'Sant Fost de Campsentelles', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('santa-eulalia-de-roncana', 'Santa Eulalia de Roncana', 'Santa Eulalia de Roncana', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('gualba', 'Gualba', 'Gualba', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('la-roca-del-valles', 'La Roca del Valles', 'la Roca del Valles', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('martorelles', 'Martorelles', 'Martorelles', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('vilalba-sasserra', 'Vilalba Sasserra', 'Vilalba Sasserra', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('vallgorguina', 'Vallgorguina', 'Vallgorguina', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('santa-maria-de-palautordera', 'Santa Maria de Palautordera', 'Santa Maria de Palautordera', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('ametlla-del-valles', 'L\'Ametlla del Valles', 'l\'Ametlla del Valles', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('vilanova-del-valles', 'Vilanova del Valles', 'Vilanova del Valles', 'Barcelona', 'Valles Oriental', 'alta'),
  generateMunicipioData('santa-maria-de-martorelles', 'Santa Maria de Martorelles', 'Santa Maria de Martorelles', 'Barcelona', 'Valles Oriental', 'alta'),
  // Barcelona - Osona (new from old site scrape)
  generateMunicipioData('sant-sadurni-d-osormort', 'Sant Sadurni d\'Osormort', 'Sant Sadurni d\'Osormort', 'Barcelona', 'Osona', 'alta'),
  generateMunicipioData('vilanova-de-sau', 'Vilanova de Sau', 'Vilanova de Sau', 'Barcelona', 'Osona', 'alta'),
  // Barcelona - Bergueda (new from old site scrape)
  generateMunicipioData('castellar-de-n-hug', 'Castellar de n\'Hug', 'Castellar de n\'Hug', 'Barcelona', 'Bergueda', 'alta'),
