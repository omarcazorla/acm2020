        ...
        <div className="container-custom">
          ...
          <div className="prose prose-lg max-w-none mb-8">
            <p className="text-lg text-gray-600 leading-relaxed">
              {loc === 'es' ? 'Catalunya cuenta con más de 200 municipios clasificados como zonas de actuación prioritaria frente al gas radón, según el Real Decreto 1029/2022. Estos municipios se distribuyen en cuatro provincias, con especial concentración en las comarcas del interior y zonas pirenaicas. La clasificación distingue entre Zona II (exposición alta, medición obligatoria en centros de trabajo) y Zona I (exposición media, medición recomendada).' :
               loc === 'ca' ? 'Catalunya compta amb més de 200 municipis classificats com a zones d\'actuació prioritària davant el gas radó, segons el Reial Decret 1029/2022. Aquests municipis es distribueixen en quatre províncies, amb especial concentració a les comarques de l\'interior i zones pirinenques. La classificació distingeix entre Zona II (exposició alta, mesurament obligatori en centres de treball) i Zona I (exposició mitjana, mesurament recomanat).' :
               ...
               'La Catalogne compte plus de 200 municipalités classées comme zones d\'action prioritaire pour le gaz radon, selon le Décret Royal 1029/2022. Ces municipalités sont réparties dans quatre provinces, avec une concentration particulière dans les régions intérieures et pyrénéennes. La classification distingue entre Zone II (exposition élevée, mesure obligatoire sur les lieux de travail) et Zone I (exposition moyenne, mesure recommandée).'}
            </p>
          </div>
